...
public class Vanilla implements Protocol {
...

	{
		...
		opCodes[0x08] = new OpCode[] { FLOAT, SHORT, FLOAT };
		...
		opCodes[0x13] = new OpCode[] { INT, BYTE, INT };
		...
		opCodes[0x1B] = new OpCode[] { FLOAT, FLOAT, BOOLEAN, BOOLEAN };
		...
		opCodes[0x27] = new OpCode[] { INT, INT, BOOLEAN };
		...
		opCodes[0x3F] = new OpCode[] { STRING, FLOAT, FLOAT, FLOAT, FLOAT, FLOAT, FLOAT, FLOAT, INT };
		opCodes[0x46] = new OpCode[] { BYTE, BYTE };
		opCodes[0x47] = new OpCode[] { INT, BYTE, INT, INT, INT };
		opCodes[0x64] = new OpCode[] { OPTIONAL_WINDOW };
		...
		opCodes[0x85] = new OpCode[] { BYTE, INT, INT, INT };
		opCodes[0xC3] = new OpCode[] { SHORT, SHORT, INT_BYTE };
		opCodes[0xC8] = new OpCode[] { INT, INT };
		opCodes[0xCA] = new OpCode[] { BYTE, FLOAT, FLOAT };
	}
}
